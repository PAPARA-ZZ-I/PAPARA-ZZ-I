function hPoints = fcn_ctrl_FigTools(h,onoff,cbPrev,cbNext,cbMeas,...
    cbRect,cbIgnore,cbPoints,cbExport,cbHelp,cbAbout)
...
hPrev = uipushtool(hToolbar,'CData',cdata,'Tag','ChangeImageButtons',...
    'TooltipString','Previous image', 'ClickedCallback',cbPrev);
...
hNext = uipushtool(hToolbar,'CData',cdata,'Tag','ChangeImageButtons',...
    'TooltipString','Next image', 'ClickedCallback',cbNext);
...
hRect = uitoggletool(hToolbar,'CData',cdata,'Tag','Toolbar_Rectangle',...
    'TooltipString','Select usable area', 'ClickedCallback',cbRect);
