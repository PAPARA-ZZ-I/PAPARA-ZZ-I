function [him,fid,sc,annotype,rectfile] = fcn_disp_image(n,imagelist,inpath,...
    h,h_sc,h_dr,drflag,aflag,userid,sep,kwlist,filterlist,infotxt,pointtype,pointmax)
...
if exist('scx','var')==1
    fcn_displayresolution(h,h_dr,drflag,[],n,imagelist,inpath,userid,sep);
end
