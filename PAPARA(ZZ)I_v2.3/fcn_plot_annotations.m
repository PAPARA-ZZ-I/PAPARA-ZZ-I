function him = fcn_plot_annotations(h,txtfile,n,imagelist,inpath,rectfile,scfile,aflag,kwlist,filterlist,infotxt,annotype,h_dr,drflag)
...
switch annotype
    case 'Annotation'
        fcn_callback = horzcat('switch get(gcbf,''SelectionType''), case ''normal''; ',...
            ...
            'aflag = fcn_defscale(aflag,''',scfile,''',h,CP,sc,''',annotype,''',h_dr,drflag); ',...
