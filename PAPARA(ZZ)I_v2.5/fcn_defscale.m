function aflag = fcn_defscale(aflag,scfile,h,CP,sc,annotype,h_ds,h_ppi,dsflag)
...
switch aflag
    ...
    case 'scale2'
        ...
        % Activate/Deactivate display resolution limit
        fcn_displayresolution(h,h_ds,h_ppi,dsflag,scfile);
